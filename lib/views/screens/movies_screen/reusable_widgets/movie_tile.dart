...
import 'package:movies_db/views/screens/movies_screen/reusable_widgets/custom_favourite_btn.dart';
              ...
              children: [
                Expanded(
                  child: Text(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500 ,fontSize: 12.sp),
                  ),
                ),
                PopularityWidget(
